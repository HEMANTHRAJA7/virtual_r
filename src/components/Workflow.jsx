...
function Workflow() {
  return (
    <div id="workflow" className="mt-20 pb-12 border-b border-neutral-800">
        ...
        <div className="pt-12 w-full lg:w-1/2">
          {checklistItems.map((item, index) => (
            <div key={index} className="flex mb-12">
              <div className=" mx-6 h-10 w-10 p-2 justify-center items-center rounded-full text-green-400">
                <CheckCircle2 />
              </div>
              <div>
